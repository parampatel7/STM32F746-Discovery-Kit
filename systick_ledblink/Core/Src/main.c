...
/*Runs on HCLK, generates regular base time of 1ms,
 *  Unlike busy-wait loops that consume CPU cycles, the SysTick timer can be used to implement delays without blocking the CPU entirely,
 *  especially when used with interrupts.*/
